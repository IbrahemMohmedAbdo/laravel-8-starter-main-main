  ...
  <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
      ...
      <x-form action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-4">
          <x-label for="user_role" class="block font-medium text-sm text-gray-700" />

          @php
              $userRole = 'admin'; // replace with actual user role
              $borderColorClass = '';
              $selectedRole = old('role', $userRole); // Use old() to retain the selected value on validation failure
              ...
              switch ($userRole) {
                  ...
                  case 'operation':
                      ...
                      break;
                  case 'client':
                      $borderColorClass = 'border-gray-300 focus:border-gray-300 focus:ring-gray-300';
                      break;
                  default:
                      $borderColorClass = 'border-gray-300 focus:border-gray-300 focus:ring-gray-300';
              }
          ...
          <x-error field="user_role" class="mt-1 font-medium text-sm text-red-600" />
      </div>
